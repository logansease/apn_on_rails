...
configatron.apn.set_default(:port, 443)
configatron.apn.set_default(:priority, 10)
...
if rails_env == 'production'
  configatron.apn.set_default(:host, 'api.push.apple.com')
  ...
  configatron.apn.set_default(:host, 'api.sandbox.push.apple.com')
